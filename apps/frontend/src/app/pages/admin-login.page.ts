...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, NgIf, AppFooterComponent],
  styles: [`
    .ff-input {
      display: block;
      width: 100%;
  ...
  `],
  template: `
    <div style="min-height:100vh;background:radial-gradient(circle at top left, rgba(22,193,198,0.12), transparent 26%), radial-gradient(circle at top right, rgba(15,30,58,0.08), transparent 22%), var(--ff-bg);display:flex;flex-direction:column;">
      <main style="flex:1;display:flex;align-items:center;justify-content:center;padding:32px 20px;">
